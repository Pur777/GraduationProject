...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_RESTAURANT_AND_DATE = "exception.lunchMenu.duplicateRestaurantAndDate";
    public static final String EXCEPTION_DUPLICATE_USER_AND_DATE = "exception.vote.duplicateUserAndDate";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "restaurants_unique_name", EXCEPTION_DUPLICATE_NAME,
            "lunch_menu_unique", EXCEPTION_DUPLICATE_RESTAURANT_AND_DATE,
            "vote_unique", EXCEPTION_DUPLICATE_USER_AND_DATE);
